...
// Modified: March 24, 2016
	...
	$setup = array (
		...
		'slug'			=> 'page_options',
		'title'			=> __('Page Settings', 'admin translation'),
		'screen'		=> 'page',
		'context'		=> 'normal',
		'priority'		=> 'high',
		'options'		=> array (
			...
			__('Layout', 'admin translation') => array (

				'0' => array (
				'name'			=> __('Page layout', 'admin translation'),
				'label'			=> 'page_layout',
				'validation'	=> '',
				'rendering'		=> '',
				'type'			=> 'radio option',
				'value'			=> 1,
				'value'			=> 'sidebar',
				'images' 		=> array('radio-graphic-layout-sidebar-right.png', 'radio-graphic-layout-full.png'),
				'options' 		=> array(
					array(__('Default layout', 'admin translation'), 'sidebar'),
					array(__('Full width layout', 'admin translation'), 'full'),
                    array(__('Custom layout (HTML)', 'admin translation'), 'custom')
				),
				'description'	=> __('Is an option to change the layout of this page, i.e. to use the default layout with a sidebar or a full width layout without sidebars.', 'admin translation')
				),

				'1' => array (
				'name'			=> __('Submenu Icon', 'admin translation'),
				'label'			=> 'submenu_icon',
				'validation'	=> '',
				'type'			=> 'text',
				'value'			=> '',
				'description'	=> sprintf(__('Is an option to define a submenu icon of this page, i.e. if this page is a submenu page and have a specific icon. Input the icon name on this field.'))
				)
			)
		)
	);
