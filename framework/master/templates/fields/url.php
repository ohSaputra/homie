...
// Modified: March 24, 2016
	...
	class Url_Field {
		...
		public static function html($slug, $field, $value, $options = array()) {
			...
			$output .= '<input type="url" class="'.$class.'" name="'.$name.'" id="'.$id.'" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" size="36"'.$tabindex.' value="'.stripslashes($value).'" />';
